...
export default function Index() {
  ...
  const handleClipDrop = (event: any, trackId?: string, index?: number) => {
                ...
                tracks.map((track, index) => (
                  <div key={track.id} style={{ border: '1px solid #000', marginBottom: '10px' }}>
                    ...
                    <div
                      ...
                      onDrop={(event) => handleClipDrop(event, track.id, index)}
                      onDragOver={handleClipDragOver}
                    >
                    ...
                    {index < tracks.length - 1 && (
                      <div
                        ...
                        onDrop={(event) => handleClipDrop(event, undefined, index)}
                        onDragOver={handleClipDragOver}
                      ></div>
                    )}
                  </div>
